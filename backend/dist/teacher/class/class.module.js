...
exports.ClassModule = ClassModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [class_controller_1.ClassController, invitation_controller_1.InvitationController],
        providers: [class_service_1.ClassService, invitation_service_1.InvitationService],
    })
], ClassModule);
